        ...
        <q-item-section>
          <q-select v-model="dashboardColorScheme" :options="colorSchemaOptions" label="Dashboard Color Schema" />
			...
			<q-item-label header style="padding-bottom: 0px"
				>Dashboard Color Scheme</q-item-label
			>
				...
				<q-item-section side top>
					...
					<div>
						...
						<q-chip
							square
							size="xs"
							:style="`background-color: ${lightColors[0]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${lightColors[1]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${lightColors[2]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${lightColors[3]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${lightColors[4]}`"
						></q-chip>
					</div>
					<div>
						...
						<q-chip
							square
							size="xs"
							:style="`background-color: ${darkColors[0]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${darkColors[1]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${darkColors[2]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${darkColors[3]}`"
						></q-chip>
						<q-chip
							square
							size="xs"
							:style="`background-color: ${darkColors[4]}`"
						></q-chip>
					</div>
				</q-item-section>
			</q-item>
