						...
						<q-item-section>
							...
							<div>
								...
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.light[0]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.light[1]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.light[2]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.light[3]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.light[4]}`"
								></q-chip>
							</div>
							<div>
								...
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.dark[0]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.dark[1]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.dark[2]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.dark[3]}`"
								></q-chip>
								<q-chip
									square
									size="xs"
									:style="`background-color: ${scheme.dark[4]}`"
								></q-chip>
							</div>
