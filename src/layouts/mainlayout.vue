				...
				<q-btn-dropdown unelevated v-model="userInfoOpen" no-caps>
					<template v-slot:label>
						<div class="row items-center no-wrap">
							...
							<div class="text-center q-pa-sm">John Smith</div>
						</div>
					</template>
					<user-info></user-info>
				</q-btn-dropdown>
...
export default {
		...
		return {
			...
			menuItems: [
				{ id: '1', title: 'Dashboard', link: '/', icon: 'dashboard' },
				{
					...
					items: [
						...
						},
						{
							...
							caption: 'API Operation Scorecard',
						},
						{
							id: 'timeline',
							title: 'Timeline',
				...
				},
				{
					...
					items: [
						{ id: '7', title: 'Login', link: '/login', icon: 'mdi-login' },
					],
				},
	...
	methods: {
		...
		initialize() {
			...
			dbColors.setColorScheme('custom orange', {
				light: [
					'#F1CA0F',
					'#149BFE',
					'#FFDAB4',
...
.db-txt-highlight,
.db-dashboard.db-theme-default.db-dark .db-txt-faded,
